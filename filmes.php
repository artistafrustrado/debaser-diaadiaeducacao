...
$cons = $xoopsDB->query("SELECT genreid, subgenreid, genretitle  FROM ".XOOPS_DB_PREFIX."_debaser_genre where subgenreid='147' order by genretitle");
