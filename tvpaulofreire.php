...
$grupolinks = 'Programas TV Paulo Freire';
...
$cons = $xoopsDB->query("SELECT genreid, subgenreid, genretitle  FROM ".XOOPS_DB_PREFIX."_debaser_genre where subgenreid='74' order by genretitle");
